...
pDataID <- c("er","pgr", "her2", "age_at_initial_pathologic_diagnosis", "grade", "dmfs_days", "dmfs_status", "days_to_tumor_recurrence", "recurrence_status", "days_to_death", "vital_status", "tissue", "treatment")
...
save(list=c("treatment_percent", "vital_status_percent", "recurrence_status_percent", "dmfs_status_percent", "GRADE_percent", "N_percent", "HER2_percent", "PGR_percent", "ER_percent"), file="./esets/summary/pData_categary_percent.rda")
...
save(ranged.data, file="./esets/summary/ranged_pData_values.rda")
