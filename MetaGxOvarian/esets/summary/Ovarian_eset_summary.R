...
#setwd("/Users/Natchar/Documents/curatedOvarianData/lwaldron-curatedovariandata/")
...
############## REMOVING DUPLICATES. keeping largest ##############
...
# SampleNumberSummaryLargest <- data.frame(NumberOfSamples = numSamples, row.names = names(esets))
# total <- sum(SampleNumberSummaryLargest[,"NumberOfSamples"])
# SampleNumberSummaryLargest <- rbind(SampleNumberSummaryLargest, total)
# ## load the duplicates list to find how many samples there are without duplicate removal
# # load("./esets/removeSamples.rda")
# rownames(SampleNumberSummaryLargest)[nrow(SampleNumberSummaryLargest)] <- "Total"


# SampleNumberSummaryPercentLargest <- data.frame(Percent = SampleNumberSummaryLargest$NumberOfSamples/total)
# rownames(SampleNumberSummaryPercentLargest) <- rownames(SampleNumberSummaryLargest)
...
# # save(list = c("SampleNumberSummary", "SampleNumberSummaryPercent"), file = "./esets/summary/ovarian/SampleNumberSummaries_ovarian.rda")

# ############## REMOVING DUPLICATES. keeping Smallest ##############


# source("./patientselection.config")
# min.number.of.genes <- 0
# remove.duplicates <- "keep.smallest"
# source("./R/createEsetList.R")
...
# SampleNumberSummarySmallest <- data.frame(NumberOfSamples = numSamples, row.names = names(esets))
# total <- sum(SampleNumberSummarySmallest[,"NumberOfSamples"])
# SampleNumberSummarySmallest <- rbind(SampleNumberSummarySmallest, total)
# ## load the duplicates list to find how many samples there are without duplicate removal
# # load("./esets/removeSamples.rda")
# rownames(SampleNumberSummarySmallest)[nrow(SampleNumberSummarySmallest)] <- "Total"


# SampleNumberSummaryPercentSmallest <- data.frame(Percent = SampleNumberSummarySmallest$NumberOfSamples/total)
# rownames(SampleNumberSummaryPercentSmallest) <- rownames(SampleNumberSummarySmallest)
# # save(SampleNumberSummary, file="./esets/summary/ovarian/SampleNumberSummary.rda")
# # save(SampleNumberSummaryPercent, file="./esets/summary/ovarian/SampleNumberSummaryPercent.rda")
# # save(list = c("SampleNumberSummary", "SampleNumberSummaryPercent"), file = "./esets/summary/ovarian/SampleNumberSummaries_ovarian.rda")
...
SampleNumberSummaryPercentAll <- data.frame(Percent = SampleNumberSummaryAll$NumberOfSamples/total)
rownames(SampleNumberSummaryPercentAll) <- rownames(SampleNumberSummaryAll)
# save(SampleNumberSummary, file="./esets/summary/ovarian/SampleNumberSummary.rda")
# save(SampleNumberSummaryPercent, file="./esets/summary/ovarian/SampleNumberSummaryPercent.rda")
# SampleNumberSummary <- cbind(SampleNumberSummaryLargest, SampleNumberSummarySmallest, SampleNumberSummaryAll)
# SampleNumberSummaryPercent <- cbind(SampleNumberSummaryPercentLargest, SampleNumberSummaryPercentSmallest, SampleNumberSummaryPercentAll)
# colnames(SampleNumberSummary) <- c("SampleNumberSummaryLargest", "SampleNumberSummarySmallest", "SampleNumberSummaryAll")
# colnames(SampleNumberSummaryPercent) <- c("SampleNumberSummaryPercentLargest", "SampleNumberSummaryPercentSmallest", "SampleNumberSummaryPercentAll")
# save(SampleNumberSummary, SampleNumberSummaryPercent, file = "./esets/summary/ovarian/SampleNumberSummaries_ovarian.rda")

save(SampleNumberSummaryAll, SampleNumberSummaryPercentAll, file= "./esets/summary/ovarian/SampleNumberSummaries_ovarian.rda")
...
save(list=c("pDataSummaryNumbersTable", "pDataPercentSummaryTable"), file = "./esets/summary/ovarian/OverallpDataSummary_ovarian.rda")
...
for(i in 1:length(esets)){
	...
	no <- length(which(as.character(pData(esets[[i]])$recurrence_status)=="norecurrence"))
